...
/*   Updated: 2023/09/19 21:24:21 by mlagrini         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
float	horizontal_distance(t_cub *var)
{
	...
	if (facing_up_down(var) == 1)
		var->ray.endy_h--;
	while (n_x && var->ray.endx_h / T_SIZE >= 0 && var->ray.endx_h / T_SIZE < var->x_max && var->ray.endy_h / T_SIZE >= 0 && var->ray.endy_h / T_SIZE < var->y_max)
	{
