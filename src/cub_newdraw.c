...
/*   Updated: 2023/09/20 18:24:55 by hrahmane         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
bool	is_up(t_cub *var)
{
	if (var->p.ray_angle > 0 && var->p.ray_angle <= 180)
		return (true);
	return (false);
}
bool	is_down(t_cub *var)
{
	if (var->p.ray_angle < 0 || var->p.ray_angle >= 180)
		return (true);
	return (false);
...
// void	get_horizontal_distance(t_cub *var)
// {
// 	int	i;
